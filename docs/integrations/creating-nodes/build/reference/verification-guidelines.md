...
Consider following these guidelines while building your node if you want to submit it for verification by n8n. Any user on an n8n instance that allows verified community nodes can discover and install verified nodes from n8n's nodes panel.
///
